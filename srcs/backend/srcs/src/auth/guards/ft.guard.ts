...
export class FtAuthGuard extends AuthGuard('42') {
    ...
    async canActivate(context: ExecutionContext) {
        ...
        if (request.isAuthenticated()){
            ...
            const activate = (await super.canActivate(context)) as boolean; // validate function burada cagiriliyor
            ...
            if (twoFactorEnabled && !twoFactorOk) {
                ...
                response.redirect(this.configService.get<string>('REACT_APP_2FA_PAGE')); // 2FA verification linki
                return false;
            }
